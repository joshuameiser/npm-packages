...
import Code from "./assets/svgs/code-brackets.svg";
...
import Plugin from "./assets/svgs/plugin.svg";
import Repo from "./assets/svgs/repo.svg";
import StackAlt from "./assets/svgs/stackalt.svg";
